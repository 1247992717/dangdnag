<template>
    <div>
        <div class="shopcart">
            <div class="content">
                <div class="content-left" @click="toggleShowFoodList">
            ...
            <transition name="move">
                <div class="shopcart-list" v-show="isShow" >
                    <div class="list-header">
                        ...
                        <span class="empty" @click="$store.commit('clearFood')">清空</span>
                    </div>
                    <div class="list-content" ref="foods">
                        <ul>
                            <li class="food" v-for="food in foods" :key="food.id">
        ...
        <transition name="fade">
            <div class="list-mask" v-show="isShow" @click="toggleShowFoodList"></div>
        </transition>
    </div>
...
<script>
    ...
    export default {
        ...
        computed:{
            ...mapState({
                foods:state => state.shop.cartFoods,
            ...
            payClass(){
                const {totalPrice} = this
                return this.info.minPrice > totalPrice ? 'not-enough' : 'enough'
            },
