<template>
    <section class="msite">
        ...
        <!--首页导航-->
        <nav class="msite_nav">
            <div class="swiper-container" v-if="categurysArr.length > 0">
                <div class="swiper-wrapper">
                    <div class="swiper-slide" v-for="(categurys,index) in categurysArr" :key="index">
                        <div class="link_to_food" v-for="(categury,index) in categurys" :key="index">
                            <div class="food_container">
                                <img :src="'https://fuss10.elemecdn.com' + categury.image_url">
                            </div>
                            <span>{{categury.title}}</span>
                        </div>
                    </div>
                </div>
                <!-- Add Pagination -->
            ...
            <img src="./images/msite_back.svg" alt="loging" v-else>
        </nav>
        <!--首页附近商家-->
...
<script>
    ...
    export default {
        ...
        async mounted() {
            ...
            await this.$store.dispatch("getFoodCategory");
