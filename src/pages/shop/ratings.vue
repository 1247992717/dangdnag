<template>
    <div class="ratings" ref="ratingsSrcoll">
        <div class="ratings-content">
            ...
            <div class="ratings-filter">
                ...
                <div class="switch" :class="{on:onlyHasTextRatings}" @click="setOnlyHasTextRatings">
            ...
            <div class="rating-wrapper" >
                <ul>
                    <li class="rating-item" v-for="(rating,index) in newRatings" :key="index">
                        <div class="avatar">
...
<script>
    ...
    export default {
        data(){
            return {
                selectType:2,
                onlyHasTextRatings:true
            }
        },
        mounted(){
            this.$nextTick(() => {
                new BScroll(this.$refs.ratingsSrcoll,{
                    click:true
                })
            })
        },
        computed: {
            ...
            newRatings() {
                const {selectType,onlyHasTextRatings} = this
                return this.ratings.filter((rating) => {

                    const {rateType,text} = rating

                    return (selectType === 2 || selectType === rateType) && (!onlyHasTextRatings || text.length > 0)
        ...
        methods:{
            ...
            setOnlyHasTextRatings(){
                this.onlyHasTextRatings = !this.onlyHasTextRatings
            }
        },
        components: {
            Star,
